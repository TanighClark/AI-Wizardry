                ...
                <div className="row justify-content-center">
                    <div className="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <ul className="list-unstyled">
                            <li><a className="link-light" href="projects-page.html">Projects Page</a></li>
                    ...
                    <div className="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <ul className="list-unstyled">
                            <li><a className="link-light" href="about.html">About Me</a></li>
                            <li><a className="link-light" href="contact.html">Contact</a></li>
                        </ul>
                    </div>
                    <div className="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
